...
function getRatPack(arr) {
  for(var i =0; i < arr.length; i++){                 //corrected to less than symbol
...
//  for(var n = 0; n < index.length; n++){          //not necessary for desired output
//    if(n == index){                               //not necessary for desired output
     return arr[index];
//    }
// }
}
...
getRatPack(ratPack);                      //changed parameter to match desired output
